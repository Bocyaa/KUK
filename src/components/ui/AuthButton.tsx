...
const AuthButton: React.FC<AuthButtonProps> = ({ provider, onClick }) => {
  return (
    <button
      onClick={onClick}
      type='button'
      className='flex justify-center items-center w-full h-10 px-4 border border-gray-300 rounded-md bg-white hover:shadow-sm transition text-sm font-medium text-gray-900'
    >
